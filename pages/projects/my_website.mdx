...
<div style={{height: '700px'}} className='img-article'>
  <Image src={old_site} fill/>
</div>
...
One of the main reasons for the overhaul was to allow me to create tutorial posts. A hefty portion of my knowledge (especially in very niche topics) has been gained through
 tutorials found on other developer's personal sites. I have always wanted to be able to contribute to this pool of knowledge, and now I can.
